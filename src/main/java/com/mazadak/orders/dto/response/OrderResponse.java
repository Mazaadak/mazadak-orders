 ...
 */
public record OrderResponse(UUID id, UUID buyerId, OrderType type, BigDecimal totalAmount, OrderStatus status, Address shippingAddress, PaymentStatus paymentStatus, List<OrderItemResponse> orderItems, String paymentIntentId, String clientSecret, UUID auctionId, UUID cartId) implements Serializable {
  }